...
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', $info->locale) }}">
...
<body
        ...
        <section class="grid gap-8">
            ...
            <section class="flex flex-col gap-4">
                ...
                <div class="flex flex-wrap gap-4">
                    @foreach ($info->get_users() as $user)
                        @isset($user['user'])
    ...
    <footer
        ...
        <div class="text-sm">
            Copyright &copy; {{ $info->vendor_name }}
            {{ $info->vendor_year }}, All Right Reserved.
        </div>
    </footer>
