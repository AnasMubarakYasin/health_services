            ...
            <x-dynamic.panel.main>
                ...
                <div class="flex flex-col gap-4 p-4 m-auto bg-base-100 w-[320px] rounded-lg">
                    <form id="form" class="flex flex-col gap-x-4 gap-y-8"
                        action="{{ route('web.administrator.orders_limit_set_handle') }}" method="post"
                        ...
                        <div class="flex flex-col gap-x-4 gap-y-8">
                            ...
                            <div class="">
                                <select name="midwife" data-te-select-init>
                                    @foreach ($midwifes as $midwife)
                                        <option value="{{ $midwife->id }}" @selected($midwife->id == $data['midwife'])>
                                            {{ $midwife->fullname ?: $midwife->name }}</option>
                                    @endforeach
                                </select>
                                <label data-te-select-label-ref>{{ trans('midwife') }}</label>
                            </div>

                            <div class="">
                                <div class="relative flex items-center" data-field="{{ 'date' }}"
                                    data-te-datepicker-init="" data-te-input-wrapper-init="">
                                    <input id="input_{{ 'date' }}" name="{{ 'date' }}" type="text"
