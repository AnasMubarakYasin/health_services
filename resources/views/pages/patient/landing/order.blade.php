<x-common.patient.landing :panel="$panel" :title="trans('order')">
    ...
    <div class="@container grid gap-4 p-4">
        ...
        <div class="@container grid gap-2 w-full">
            @error('api')
                <div
            ...
            @enderror
            <form action="{{ route('web.patient.landing.api_order', ['midwife' => $midwife]) }}" method="POST"
                            ...
                            <div>
                                <div>
                                    <div class="relative" data-te-input-wrapper-init>
                                        ...
                                        <label id="toggle_map"
                                            data-href="{{ route('web.patient.landing.map_select') }}" role="button"
