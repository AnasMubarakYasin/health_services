<x-common.patient.landing :panel="$panel" :title="trans('order')">
    ...
    <div class="@container w-full grid p-4 gap-4">
        ...
        @enderror
        <form action="{{ route('web.patient.order_common.handle') }}" method="POST"
                ...
                <div>
                    <select id="service" name="service" data-te-select-init>
                        ...
                        @foreach ($services as $service)
                            <option value="{{ $service->id }}" @selected(old('service') == $service->id) class="capitalize">
                                {{ $service->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div>
                <div id="date" class="relative" data-te-input-wrapper-init data-te-inline="true">
                    <input id="date" name="date" type="text" value="{{ old('date') }}" autocomplete="off"
